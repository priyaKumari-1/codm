import './FinancialServiceCloud_First.css';
import bgImg from "../../../assets/imgs/page-header/bg-line.png";


const FinancialServiceCloud_First = () => {
            ...
            <section className="FinancialServiceCloud_First section-page-header py-10 fix position-relative">
                <div className="container position-relative z-1 mt-5">
                    <div className="text-start">
                        <h4 className='customServiceHeading'>Salesforce Financial Services Cloud</h4>
                        <div className="d-flex">
                            ...
                            <p className="purple-text mb-0 fw-bold">Financial Cloud</p>
...
export default FinancialServiceCloud_First;
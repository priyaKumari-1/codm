            ...
            <section className="FinancialServiceCloud_First section-page-header py-10 fix position-relative">
                <div className="container position-relative z-1 mt-5">
                    <div className="text-start">
                        <h3 className="customServiceHeading" style={{fontSize:"32px"}}>Data Integration/Migration</h3>
                        ...
                        <div className="d-flex">
                            ...
                            <p className="purple-text mb-0 fw-bold">Data Integration/Migration</p>
...
export default DataIntegration_First;
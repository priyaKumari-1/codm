            ...
            <section className="FinancialServiceCloud_First section-page-header py-10 fix position-relative">
                <div className="container position-relative z-1 mt-5">
                    <div className="text-start">
                        <h4 className="customServiceHeading">Salesforce Marketing Cloud Services</h4>
                        ...
                        <div className="d-flex">
                            ...
                            <p className="purple-text mb-0 fw-bold">Marketing Cloud</p>
...
export default MarketingCloud_First;
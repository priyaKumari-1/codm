import img1 from '../../../assets/imgs/service-4/TechSupport.png';
      ...
      <div className="row rounded-3 bg-white">
        ...
        <div className="col-lg-7">
          <div className="p-lg-3">
            ...
            Reliable Tech Support That Keeps You <span className="fw-bold">Running</span>
            </h3>

...
import img2 from '../../assets/imgs/services-details-2/Revenue-Cloud/img-2.png';
import sumitImage from '../../assets/imgs/services-details-2/Revenue-Cloud/sumit-tiwari.png';
import bgImg from '../../assets/imgs/services-details/bg-line-3.png';

function SalesforceRevenueCloudSidebar() {
  return (
    <div>
        <BlogSidebar/>
        {/* next */}
                        ...
                        <div className="mt-5" style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                            <iframe
                                src="https://www.youtube.com/embed/EdoR5GwY4D4?si=9zPtIooriSAllBuE"
                                title="YouTube video"
                                frameBorder="0"
...
export default SalesforceRevenueCloudSidebar;
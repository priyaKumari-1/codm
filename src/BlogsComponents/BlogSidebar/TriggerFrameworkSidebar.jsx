...
import img2 from '../../assets/imgs/services-details-2/triggerframework/img-2.png';
import chanderImage from '../../assets/imgs/services-details-2/triggerframework/chanderkant.png';
import bgImg from '../../assets/imgs/services-details/bg-line-3.png';

function TriggerFrameworkSidebar() {
  return (
    <div className=''>
        <BlogSidebar/>
        {/* next  */}
                        ...
                        <div className="mt-5" style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                            <iframe
                                src="https://www.youtube.com/embed/U5ZOA9EY3Kg?si=-2M7qVNkE9XLMsTJ"
                                title="YouTube video"
                                frameBorder="0"
                        ...
                        <div class="developer-info mt-4 pt-3">
                            <div class="d-flex align-items-center">
                                <img src={chanderImage} alt="Yamini Sharma" class="rounded-circle me-3" width={'100%'} />
                            </div><p class="mb-1 text-muted">Written by:</p><p class="mb-0 fw-semibold">Chander Kant, Senior Salesforce Developer
...
export default TriggerFrameworkSidebar
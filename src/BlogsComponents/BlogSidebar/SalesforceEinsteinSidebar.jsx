...
import img2 from '../../assets/imgs/services-details-2/EinsteinAI/img-2.webp';
import img3 from '../../assets/imgs/services-details-2/EinsteinAI/img-4.png';
import prachipathakImage from '../..//assets/imgs/services-details-2/EinsteinAI/prachipathak.png';
import bgImg from '../../assets/imgs/services-details/bg-line-3.png';

function SalesforceEinsteinSidebar() {
  return (
    <div>
        <BlogSidebar/>
        {/* next  */}
                        ...
                        <div className="mt-5" style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                            <iframe
                                src="https://www.youtube.com/embed/2-LkbM-V4m8?si=X3jJlAGo7SkdC-ZZ"
                                title="YouTube video"
                                frameBorder="0"
                        ...
                        <div class="developer-info mt-4 pt-3">
                            <div class="d-flex align-items-center">
                                <img src={prachipathakImage} alt="Yamini Sharma" class="rounded-circle me-3" width={'100%'} />
...
export default SalesforceEinsteinSidebar;
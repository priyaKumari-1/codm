...
const codeSnippet = `
// Interface Framework Handler Trigger code below
    ...
    <section className="section-integration-framework position-relative py-4">
      <div className="container">
        ...
        <div className="d-flex justify-content-between align-items-center mb-3">
          <h4 className="fw-bold text-900 mb-0">Interface FrameWork Handler Trigger</h4>
          <button
...
export default TriggerFrameInterface;